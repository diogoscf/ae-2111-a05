...
if __name__ == "__main__":
    ...
    torque_diagram(0.908, [engine_mass], 3.75, 3703.338805)
    torque_diagram(0.908, [engine_mass], 3.75, 8328.245793)
    torque_diagram(0.908, [engine_mass], 3.75, 4838.801824)
    torque_diagram(2.27, [engine_mass], -1.5, 1481.335522)
    torque_diagram(2.27, [engine_mass], -1.5, 3331.298316)
    torque_diagram(2.27, [engine_mass], -1.5, 1935.52073)
